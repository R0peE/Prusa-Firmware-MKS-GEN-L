...
/*MKS*/
    ...
    #else
      #define ADC_CHAN_MSK      0b1001000000000000 //used AD channels bit mask (12 = TEMP_0_PIN, 15 = TEMP_BED_PIN)
      #define ADC_DIDR_MSK      0b1001000000000000 //AD channels DIDR mask (1 ~ disabled digital input)
      #define ADC_CHAN_CNT      2         //number of used channels)
    #endif
    #define ADC_OVRSAMPL      16        //oversampling multiplier
    #define ADC_CALLBACK      adc_callback //callback function ()
